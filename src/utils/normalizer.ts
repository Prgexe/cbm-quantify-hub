...
const POSTO_PATTERNS: Array<{ canonical: string; patterns: string[] }> = [
  { canonical: "Tenente Coronel", patterns: ["TENENTE CORONEL", "TEN CEL", "TEN. CEL", "TENCEL", "TC"] },
  { canonical: "Coronel", patterns: ["CORONEL", "CEL"] },
  { canonical: "Major", patterns: ["MAJOR", "MAJ"] },
  { canonical: "Capitão", patterns: ["CAPITAO", "CAPITÃO", "CAP"] },
  { canonical: "1º Tenente", patterns: ["1 TENENTE", "1 TEN", "1ºTEN", "1º TEN", "PRIMEIRO TENENTE"] },
  { canonical: "2º Tenente", patterns: ["2 TENENTE", "2 TEN", "2ºTEN", "2º TEN", "SEGUNDO TENENTE"] },
  { canonical: "Tenente", patterns: ["TENENTE", "TEN"] },
  { canonical: "Subtenente", patterns: ["SUBTENENTE", "SUB TEN", "SUBTEN", "ST"] },
  { canonical: "1º Sargento", patterns: ["1 SGT", "1ºSGT", "1º SGT", "PRIMEIRO SARGENTO", "1 SARGENTO"] },
  ...
  { canonical: "Soldado", patterns: ["SOLDADO", "SD", "SD BM", "SDBM", "SOLDADO BM",
    "SD TEMP", "SDTEMP", "SOLDADO TEMPORARIO", "SOLDADO TEMPORÁRIO", "SD TEMPORARIO",
    "SD TEMPORÁRIO", "RECRUTA", "ALUNO"] },
];
