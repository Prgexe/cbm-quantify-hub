...
import { sortByUnitHierarchy, getOrderedUnidades } from "@/utils/unitOrder";
...
export default function ConsolidatedTab() {
  ...
  const exportXlsx = () => {
    ...
    // Agrupa por CBA/AREA, aplicando ordenação hierárquica dentro de cada grupo
    const grouped: Record<string, MilitarRecord[]> = {};
    for (const r of sortByUnitHierarchy(filtered)) {
